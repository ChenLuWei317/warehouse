...
public class AddUserController {
    ...
    // 确保这里的类型与FXML中的对应
    @FXML
    private BorderPane mainVbox; // 此字段对应 FXML 中的 BorderPane
    ...
    public void AddUserButtonOnClick() {
        ...
        if (name.isEmpty() || gender == null || birthDate == null || hometown.isEmpty() ||
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR, "请填写所有字段！");
            alert.showAndWait();
        ...
        try {
            ...
            // 处理异常，例如弹出错误提示
            Alert alert = new Alert(Alert.AlertType.ERROR, "添加失败：" + e.getMessage());
            alert.showAndWait();
        }
    }
